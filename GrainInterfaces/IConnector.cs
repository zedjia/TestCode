...
{
    public interface IConnector : IMsgPublisher, ISubscriber
    {
        /// <summary>
        ...
        Task SetUserDetails(ConnectorInfo userInfo);
        ...
        Task<List<ConnectorInfo>> GetFollowingList();
        ...
        Task<List<ConnectorInfo>> GetFollowersList();
        ...
        Task<List<MessageInfo>> GetReceivedMessages(int n = 10, int start = 0);
        ...
        Task ViewerConnect(IViewer viewer);
        ...
        Task ViewerDisconnect(IViewer viewer);
